...
function renderRoster() {
    ...
    if (currentCalendarType === '행사장') {
        rosterGrid.style.gridTemplateColumns = `60px 120px repeat(${daysInMonth}, minmax(32px, 1fr))`;
    } else {
        rosterGrid.style.gridTemplateColumns = `minmax(180px, auto) repeat(${daysInMonth}, minmax(32px, 1fr))`;
    }
